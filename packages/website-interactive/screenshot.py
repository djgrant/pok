#!/usr/bin/env python3
"""
Browser interaction tool for the interactive website.

This tool maintains a persistent browser session via a Unix socket server,
allowing fast interactions without re-booting the WebContainer each time.
...
def run_server():
    ...
    with sync_playwright() as p:
        ...
        print("Page loaded. Waiting for WebContainer to boot...")
...
def main():
    parser = argparse.ArgumentParser(
        description="Browser interaction tool for the interactive website",
