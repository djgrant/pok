...
**Recommended Second PR:** Add `introspect` function that returns the command tree with JSON Schema representations of each command's context. This enables agents to understand _what commands exist and how to call them_.
