...
This flow keeps command logic separate from rendering, makes event assertions straightforward in tests, and allows multiple adapters to consume the same execution stream.
