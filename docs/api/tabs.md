...
```typescript
import type { TabsAdapter, TabSpec, TabsOptions } from '@openpok/core';
...
- [@openpok/tabs-ink](../packages/tabs-ink.md) - Ink implementation
- [@openpok/tabs-core](../packages/tabs-core.md) - Shared logic
