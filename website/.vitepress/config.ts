...
export default defineConfig({
  title: 'pok',
  description: 'A file-based CLI framework for building beautiful command-line interfaces with TypeScript',
  ...
  themeConfig: {
    ...
    // Social links
    socialLinks: [
      { icon: 'github', link: 'https://github.com/notation-dev/openpok' }
    ],
  ...
  head: [
    ...
    ['meta', { name: 'og:description', content: 'A file-based CLI framework for building beautiful command-line interfaces with TypeScript' }]
  ]
})
